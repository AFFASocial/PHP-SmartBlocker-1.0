...
Just download the <code> .zip Unzip the files and click on the PHP_SmartBlocker_1.0_Installation_Guide.html and it should open in your browser follow the instructions and DONE. You can copy the code snippets directly from the installation guide during the installation.
