...
Just download the PHP_SmartBlocker_1.0_Installation_Guide.html and then click the file and it should open in you browser follow the instructions and DONE.
